...
public class FrontSearchController extends BaseController{
	...
	public String search(
			String t, //查询种类	文章或者留言
			@RequestParam(required=false) String q, 	//查询字段
			@RequestParam(required=false) String qand, 	//必须带有
			@RequestParam(required=false) String qnot, 	//必须不带有
			@RequestParam(required=false) String a, 	//普通/高级查询
			@RequestParam(required=false) String cid, 	//
			@RequestParam(required=false) String bd,	//开始日期
			@RequestParam(required=false) String ed, 	//结束日期

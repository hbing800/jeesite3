...
public class StatsService extends BaseService {
	...
	public List<Map<String, Object>> article(Map<String, Object> paramMap) {
		...
		ql.append("  count(a.id) as cnt, sum(a.hits) as hits, max(a.updateDate) as updateDate) ");
		ql.append("  from Article a join a.category c join c.parent cp where c.site.id = ");
